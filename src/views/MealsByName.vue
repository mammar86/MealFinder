      ...
      <div v-for="meal in appStore.mealsByName" :key="meal.id" class="bg-white shadow rounded-xl">
        ...
        <div class="p-2">
          ...
          <div class="flex item-center justify-between py-2">
            <a :href="meal.strYoutube" target="_blank" class="p-3 rounded border-2 border-red-700 hover:bg-red-600 hover:text-white transition-colors">Youtube Link</a>
            <router-link to="/" class="p-3 rounded border-2 border-green-700 hover:bg-green-600 hover:text-white transition-colors"> Details </router-link>
          </div>
        </div>
      </div>
    </div>
